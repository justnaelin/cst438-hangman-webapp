...
public class HangmanWebclientSteps {
    ...
    public void i_see_the_output(String output) throws Throwable {
        // The greeting is rendered dynamically with JavaScript.
        // Wait for the page to load, timeout after 10 seconds
        (new WebDriverWait(driver, 10))
            .until(ExpectedConditions.textToBe(By.id("pattern"), output));
    }

    @Then("^I see nothing happen$")
    public void i_see_nothing_happen() throws Throwable {
        // The greeting is rendered dynamically with JavaScript.
        // Wait for the page to load, timeout after 10 seconds
        (new WebDriverWait(driver, 10))
